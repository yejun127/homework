    ...
    return (
      <div className="HomePage">
        <div class="grid-container">
          <div class="grid-item">
            <p><a href="/BlogPost1">8 Experiments in Motivation</a></p><br />
          </div>
          <div class="grid-item">
            <p><a href="/BlogPost2">A Mindful Shift of Focus</a></p><br />
          </div>
          <div class="grid-item">
            <p><a href="/BlogPost3">How to Develop an Awesome Sense of Direction</a></p><br />
          </div>
          <div class="grid-item">
            <p><a href="/BlogPost4">Training to Be a Good Writer</a></p><br />
          </div>
          <div class="grid-item">
            `<p><a href="/BlogPost5">What Productivity Systems Won't Solve</a></p>`<br />
          </div>
        </div>
      </div>
    )
...
class BlogPost2 extends React.Component {
  render() {
    ...
    <article>
      ...
      <p><b>Mindfulness of Frustration</b></p>
      ...
      <p>Now notice what it is in this moment that you wish were different. What is missing from this moment that is frustrating you? <q>Frustration stems from what you don't have.</q></p>'
      '<p>What do I mean by this? There's something you don't have right now, that you wish you had, and that lack of what you want is frustrating you.' A few examples:
      <br />- My child isn't behaving the way I want her to... what I don't have is "ideal" behavior from her. (Actually, it's my ideal, not hers.)<br />- My computer keeps crashing, and I'm frustrated... what I don't have is a computer that behaves ideally.<br />- People are saying things online that irritate me... what I don't have is a bunch of people who agree with me or behave in the way I want.<br />- Traffic backed up and stressing me out... what I don't have is a stress-free, peaceful drive home.<br />- My spouse criticized me... what I don't have is someone who thinks I'm an awesome husband right now, or their praise.<br /></p>'
      ...
      <p><b>Mindfulness of Your Story</b></p>'
      ...
      <p><b>Mindfulness of What Is Already Here</b></p>
      ...
      <p>What I've found to work is focusing on what I can appreciate about this moment. Let's take the examples from above:<br /> - I'm frustrated by my child's behavior... I can breathe, and appreciate things about this moment: my child is actually a wonderful person, who might not behave perfectly all the time (who does?), who is alive! And in my life! And I love her deeply.
    <br /> - My computer keeps crashing, and I'm frustrated... what I don't have is a computer that behaves ideally.<br /> - People say irritating things online... I can breathe, and appreciate: I get to read amazing things online! I'm alive! People are diverse and interesting and messy, and I love humanity for that precious fact.<br /> - Traffic backed up and stressing me out... what I don't have is a stress-free, peaceful drive home.<br /> - My spouse criticized me... I can breathe, and appreciate: she's a great spouse, and a person with a different way of doing things, and I'm happy to have her in my life. And maybe she's frustrated herself, and could use a hug.</p>'
      ...
      '<p><b>Frustration in the Midst of Injustice</b></p>'
...
class BlogPost3 extends React.Component {
  render() {
    ...
    <article>
      ...
      <p>1. <i>First, look at a map for a few minutes.</i><br />I will open Google Maps and look at the city and its major landmarks and features. Is there a river, lake, harbor, sea shore? Is there a big central park, or several big parks? Where is the downtown area? What are the major neighborhoods? Major roads? Famous buildings, like the Sydney Opera house? What's to the north or south?<br /></p>'
      <p>2. <i>Walk around a lot.</i><br />When I first get to a city, I like to walk around a lot. This is the best way to get to know a city, to wander and start to develop a sense of where things are and how the city looks. But read on to understand how you need to walk around -- 'it's not just aimless.</p>'
      '<p>3. <i>Orient to some landmarks.</i><br />I like to find a major building, mountain, hill, bridge, that I can keep in view as I walk around. That way when I turn left, I can say, "Oh, the Empire State Building is now over there." This helps me have a point of reference, so I always know where I am relative to that point. Sometimes I have two or more landmarks.</p>
      <p>4. <i>Look at a map a lot in the beginning, but don't rely on it completely.</i><br />This is the key. When you look at a map for a few minutes, then walk around, what you're doing is forming a mental map of the city. At first, it's real vague, but as you walk, you're adding to the map. See how the streets line up in reality compared to how you thought they line up after you first looked at the map.</p>
      <p>5. <i>Look at a map a lot in the beginning, but don't rely on it completely.</i><br />As you form your mental map, get in the habit of looking at the paper map in your hand, or the map on your phone, so you can fill in your mental map... but then put away the map and walk without it. Then look at the map again after a little while to fill in your mental map some more. It's a process of learning the map by looking at it every now and then, but not relying on it. If you just follow the map all the time, you don't ever rely on your mental map.</p>'
      <p>6. <i>Keep your orientation as you walk around.</i><br />When you walk to a destination, or even wander aimlessly, it's easy to forget where you are or what direction you're facing. This is not useful. Instead, if you make a left turn, think, "Oh, now I'm going west," and also remember where your landmark is in relation to where you are. For example, if I start out heading straight for the Eiffel Tower, but then turn left, that means the Eiffel Tower is now on my right. Your mental map should rotate a bit too so you're now facing south instead of west (for example). In this way, you should always know which way to go to get home (to your apartment or hotel).</p>'
      <p>7. <i>Don't just follow someone else or rely on taxis -- figure it out yourself.</i><br />One of the biggest mistakes a lot of people make is to just follow their spouse or a guide or let taxis take them places. You will never figure out the lay of the land this way. Instead, figure out how to get places yourself. Yes, you'll make mistakes, but you'll eventually get it. Get lost, then check a map, and figure out how to get where you want to go. It's the only way.</p>
      <p>8. <i>Continually work on your mental map, and test it.</i><br />As you walk around, continually update the mental map. Look at the map again, close it, and test out how well you know the city. It's a constant process.</p>'
      <p>9. <i>Keep an eye on the names of streets.</i><br />I like to look at street names as I walk around. Then I'll look at the street names on a map. Eventually, I get to know which streets head east and west, and which go north and south, and what order they're in.</p>
      <p>10. <i>Mark the major streets in your mental map.</i><br />Every neighborhood has its major streets, with shopping and restaurants and the like. Get to know where those are, and put them prominently on your mental map. You should get to the point where you can point the direction of these major streets, and even know generally how many blocks to get to them. Same with major parks and marketplaces and water features like rivers. And metro stops.
...
class BlogPost5 extends React.Component {
  render() {
    ...
    <article>
      ...
      <p>No matter how good the productivity system is, <i>it falls apart when I start procrastinating.</i></p>
      ...
      <p>Often, we'll work on a new productivity system, try out a new to-do list app, start organizing, or start getting our email inbox to zero, or start reading about a new way to be productive (like you are now)... <i>all as a way to procrastinate on uncertain or uncomfortable tasks.</i></p>'
...
class App extends React.Component {
  ...
  render() {
    ...
    else if (this.state.currentPage === "/BlogPost1") {
      return (
        <div>
          <Header />
          <BlogPost1 />
    ...
    else if (this.state.currentPage === "/BlogPost2") {
      return (
        <div>
          <Header />
          <BlogPost2 />
    ...
    else if (this.state.currentPage === "/BlogPost3") {
      return (
        <div>
          <Header />
          <BlogPost3 />
    ...
    else if (this.state.currentPage === "/BlogPost4") {
      return (
        <div>
          <Header />
          <BlogPost4 />
    ...
    else if (this.state.currentPage === "/BlogPost5") {
      return (
        <div>
          <Header />
          <BlogPost5 />
